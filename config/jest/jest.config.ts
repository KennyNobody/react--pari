...
export default {
    ...
    // Can be specified as % or a number. E.g. maxWorkers: 10% will use 10% of your CPU
    // amount + 1 as the maximum worker number. maxWorkers: 2 will use a maximum of 2 workers.
    // maxWorkers: "50%",
